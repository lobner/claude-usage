...
func TestBundleFor(t *testing.T) {
	tests := []struct {
		...
		{"/Applications/Claude Usage.app/Contents/MacOS/claudeusage", "/Applications/Claude Usage.app"},
		{"/Users/x/tools/My App.app/Contents/MacOS/bin", "/Users/x/tools/My App.app"},
		{"/Users/x/workspace/claude-usage/claudeusage", ""}, // plain `go build`
		{"/tmp/go-build123/b001/exe/main", ""},              // `go run .`
		{"/Applications/Thing.app/Contents/Resources/claudeusage", ""},
		{"/Applications/Thing/Contents/MacOS/claudeusage", ""}, // not a bundle
	}
